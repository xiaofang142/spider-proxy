...
| 功能模块 | 功能 | 说明 |
|---------|------|------|
| 请求体替换 | Map Local/Remote | 本地文件/远程 URL 替换请求响应体 |
| WebSocket | WebSocket 抓包 | 连接捕获 + 实时消息流 + 状态监控 |
| 断点调试 | UI 完善 | 手动修改请求/响应编辑器 |
| 脚本系统 | 完整 JavaScript 引擎 | dart_eval 沙盒执行 + 内置库 + 8 个模板 |
...
- ✅ **请求体替换 (Map Local/Remote)**: 本地文件/远程 URL 替换、5 秒 TTL 缓存、文件热更新
- ✅ **WebSocket 抓包**: 自动捕获、实时消息流、连接状态监控、时长统计
- ✅ **断点调试 UI 完善**: Tab 标签页编辑器、请求/响应双向编辑、修改状态指示
- ✅ **完整 JavaScript 引擎**: dart_eval 沙盒、proxy://context 库、8 个内置脚本模板
...
*Last Updated: 2026-03-26 - v3.0 Released*
